...
class SawyerDoorMultitaskEnv(MultitaskEnv, SawyerXYZEnv):
    def __init__(
            self,
            k_tasks=1,
...
register(
    id="SawyerDoorFixedSingleTask-v0",
    entry_point="rl_maml_tf.envs.sawyer.door_multitask:door_env",
    # Block goal can be in the air.
    kwargs=dict(frame_skip=5,
                k_tasks=1,
...
register(
    id="SawyerDoorFixedMultitask-v0",
    entry_point="rl_maml_tf.envs.sawyer.door_multitask:door_env",
    # Block goal can be in the air.
    kwargs=dict(frame_skip=5,
                k_tasks=3,
...
register(
    id="SawyerDoorFixedMultitaskSparse-v0",
    entry_point="rl_maml_tf.envs.sawyer.door_multitask:door_env",
    # Block goal can be in the air.
    kwargs=dict(frame_skip=5,
                k_tasks=3,
