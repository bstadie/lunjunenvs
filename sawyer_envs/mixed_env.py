...
def mixed_env(**kwargs):
    #from rl_maml_tf.envs.sawyer.flat_goal_env import FlatGoalEnv
...
register(
    id="SawyerMixedMultitask-v0",
    entry_point="rl_maml_tf.envs.sawyer.mixed_env:mixed_env",
...
register(
    id="SawyerMixedMultitaskId-v0",
    entry_point="rl_maml_tf.envs.sawyer.mixed_env:mixed_env_with_id",
    # Block goal can be in the air.
    kwargs=dict(frame_skip=5,
                k_tasks=6,
...
register(
    id="SawyerMixedFixedMultitaskId-v0",
    entry_point="rl_maml_tf.envs.sawyer.mixed_env:mixed_env_with_id",
    # Block goal can be in the air.
    kwargs=dict(frame_skip=5,
                k_tasks=6,
...
register(
    id="SawyerMixedPointMultitask-v0",
    entry_point="rl_maml_tf.envs.sawyer.mixed_env:mixed_env",
    # Block goal can be in the air.
    kwargs=dict(frame_skip=5,
                k_tasks=6,
...
register(
    id="SawyerMixedMultitaskDebug-v0",
